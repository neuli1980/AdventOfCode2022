...
namespace AdventOfCode2022
{
    public class Day7
    {
        ...
        {
            SolvePart1(File.ReadAllText("Day7_Introduction.txt"), 95437);
        }

        [Fact]
        public void Introduction2()
        {
            SolvePart2(File.ReadAllText("Day7_Introduction.txt"), 0);
        }
        ...
        public void PuzzlePart1()
        {
            ...
            SolvePart1(File.ReadAllText("Day7_Puzzle.txt"), 0);
        }
        ...
        public void PuzzlePart2()
        {
            ...
            SolvePart2(File.ReadAllText("Day7_Puzzle.txt"), 0);
        }
    }
}